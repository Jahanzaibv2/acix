...
<html lang="en">
  <head>
    ...
    <title>RC-POS - Sales Reports</title>
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <script src="app-include/js/chart-area-demo.js"></script>
      <script src="app-include/js/chart-bar-demo.js"></script>
      <script src="app-include/js/chart-pie-demo.js"></script>
    </body>
  </html>
