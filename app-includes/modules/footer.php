      ...
      <div class="container my-auto">
        <div class="copyright text-center my-auto ">
          ...
          <small class="text-muted">
            You're using  v1.0 of this software. <a href="https://github.com/appzaib/acix/releases" target="_blank"> <i class="fa fa-external-link"></i> Check for Updates</a>. In order to report a bug, please create an issue <a href="https://github.com/appzaib/acix/issues" target="_blank">here.</a>
            <br><br><br>
